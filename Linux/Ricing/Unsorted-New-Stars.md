## Newly starred repos, not yet sorted into a category
...
- https://github.com/xmb9/Priism
    - Language: Shell
    - Portable recovery image installer/shim manager

- https://github.com/aroncondosas/host-craft
    - Language: Rust
    - Host Craft is a personal project which tries to eliminate the need of understanding how to run a Minecraft Server. It just creates one and saves it in a Git Repo so that you can always play with your friends easily and without any cost.

- https://github.com/KevKibe/Automated-Serverless-App-Uptime-Maintenance-with-Rust-and-GitHub-Actions
    - Language: Rust
...
- https://github.com/abhay-byte/fluxlinux
    - Language: Kotlin
...
- https://github.com/Roboticela/Animator
    - Language: TypeScript
    - Free, open-source 3D model animation studio — import rigged models, inspect bones, author keyframe animations, apply premade clips, and export GLB. Browser + desktop (Tauri).
...
- https://github.com/dshawshank/APP-android_arm64
    - Language: Python
...
- https://github.com/AsertCreator/NetBlox
    - Language: C#
    - weird roblox clone written in c#

- https://github.com/ReWelp/HayasexShiru-Extensions
    - Language: JavaScript
    - Community-maintained extensions for Shiru and Hayase. Includes Nyaa and Sukebei support.
...
- https://github.com/Mustard2/MustardUI
    - Language: Python
...
- https://github.com/venomgfx/blender-ui
    - Language: Pug
    - Blender mockups in web format

- https://github.com/alexisrolland/ComfyUI-Blender
    - Language: Python
    - Custom nodes and add-on to use ComfyUI from Blender.
...
- https://github.com/SomeGuy6858/MRMM
    - Language: Python
...
- https://github.com/DrPariah/hentaimod
    - Language: ?
...
- https://github.com/Tips-Discord/Cwelium
    - Language: Python
    - Cwelium is a open source Discord Raider with various features Its ALWAYS UpToDate
...
- https://github.com/abint7/free-domains
    - Language: ?
...
- https://github.com/knockshore/dockerportable
    - Language: Shell
    - A portable docker VM using QEMU for Windows. No admin privileges and no installations

- https://github.com/uniras/Portable-Docker-for-Windows
    - Language: Batchfile
...
- https://github.com/maelstrom-rs/maelstrom
    - Language: Rust
    - The Matrix homeserver for serious scale. Clusterable, highly available, horizontally scalable.
...
- https://github.com/Lolappa/Telegram-Matrix-Bridge
    - Language: Rust
    - Rut project to bridge messages between Telegram and Matrix

- https://github.com/msrd0/tg2mx_bot
    - Language: Rust
    - Bot to import telegram sticker packs to matrix MSC2545 (Ponies) stickers to use with FluffyChat, Nheko, Cinny etc

- https://github.com/PantherApex/Panther
    - Language: Rust
    - A self-hosted AI agent daemon built in Rust. Runs on your machine, talks through Telegram, Discord, Slack, Email and Matrix. Fully local with Ollama or powered by any of 12 cloud providers. Execute commands, capture media, schedule tasks, browse the web , all from a chat message.

- https://github.com/ultram4rine/alerter
    - Language: Rust
    - Telegram and Matrix bot for alerts from Alertmanager

- https://github.com/LuckyTurtleDev/mstickereditor
    - Language: Rust
    - import sticker packs from telegram, to be used at the Maunium sticker picker for Matrix

- https://github.com/hexagonal-sun/llamatrix
    - Language: Rust
    - An ollama Matrix bridge bot

- https://github.com/jpypi/rustix
    - Language: Rust
    - Matrix chat bot written in Rust

- https://github.com/turboflakes/crunch
    - Language: Rust
    - Crunch is a command-line interface (CLI) and Matrix Bot to claim staking rewards  every Era for Substrate-based chains

- https://github.com/sparky8251/anansi
    - Language: Rust
...
- https://github.com/samandar-me/PinterestApp
    - Language: Kotlin
...
- https://github.com/drunkleen/leenfetch
    - Language: Rust
    - modern, minimal, and the fastest neofetch like system information tool with remote fetch ability, written in Rust.
...
- https://github.com/SegoCode/AutoWall
    - Language: AutoIt
...
- https://github.com/Miosp/city_grow_lively
    - Language: Rust
    - This is a port of the City Grow animation for Lively Wallpaper app for Windows
...
- https://github.com/motebaya/pindl-app
    - Language: Dart
...
- https://github.com/joshjetson/sshing
    - Language: Rust
    - An advanced ssh server management tool that is simple and easy to use

- https://github.com/nasa42/webterm
    - Language: Rust
    - Securely access a server's terminal even when they are behind firewalls

- https://github.com/TomCrypto/zssh
    - Language: Rust
    - Minimal SSH server for embedded applications.

- https://github.com/mkj/sunset
    - Language: Rust
...
- https://github.com/catacombing/catacomb
    - Language: Rust
    - Moved to SourceHut
...
- https://github.com/reyk/retris
    - Language: Rust
    - reyk's Tetris clone written in Rust
...
- https://github.com/myaple/grw
    - Language: Rust
    - A TUI written in rust to watch git repos in real-time.
...
- https://github.com/cyb3rko/awesome-matrix-bots
    - Language: ?
    - A list of Matrix bots, bridges and related things
...
- https://github.com/maxomatic458/bedwa-rs
    - Language: Rust
    - a bedwars server written in rust
...
- https://github.com/PokeJofeJr4th/javarust
    - Language: Rust
...
- https://github.com/nullclyze/salarixi
    - Language: Rust
    - Moved to https://codeberg.org/nullclyze/salarixi
...
- https://github.com/bosseschum/WebWM
    - Language: Rust
    - A web technology based Wayland window manager. Written in Rust, configured in XML, CSS and JS.

- https://github.com/Inparsian/gray-meadows-shell
    - Language: Rust
    - super over-engineered rust gtk shell with an ai that can shut down your computer
...
- https://github.com/xtoxico/tachyonterm
    - Language: Rust
    - A blazing fast, AI-native TUI terminal emulator written in Rust. No X11/Wayland required.
...
- https://github.com/cybergaz/waybar-now-playing
    - Language: Rust
...
- https://github.com/GhostKellz/nova
    - Language: Rust
    - Wayland-Native Virtualization & Container Manager Bare metal speed. Declarative control. GPU-first.
...
- https://github.com/wiremann/wiremann
    - Language: Rust
    - A fast, no-nonsense music player built in Rust. Just pure, native speed.
...
- https://github.com/catpranks/WaywardGriffin
    - Language: Rust
    - X11 -> Wayland local display proxy
...
- https://github.com/playfairs/YaWC
    - Language: Rust
    - The GitHub repository Mirror for the YaWC Compositor Core, do not make Issues or Pull Requests through here, do it from the official repository through GitLab. [maintainer=@invra]
...
- https://github.com/stefur/lizzy
    - Language: Rust
    - A customizable Waybar module for media playback that uses DBus signals [read-only mirror]
...
- https://github.com/isomerc/nicotine
    - Language: Rust
    - A high performance Eve Online multiboxing and client management tool for Linux + Windows systems  | Join the Discord -> https://discord.gg/N82KJcS47f
...
- https://github.com/sxndmxn/grxxt
    - Language: Rust
    - Brutalist, compositor-agnostic TUI greeter for greetd
...
- https://github.com/veilm/creak
    - Language: Rust
    - notifications for wayland without dbus
...
- https://github.com/0xferrous/wispd
    - Language: Rust
...
- https://github.com/andreivinca/notitui
    - Language: Rust
    - Terminal notification center for Wayland: a background JSONL logger (notilog) plus a Ratatui viewer (notitui) for browsing missed/history notifications.

- https://github.com/SykikXO/inno
    - Language: Rust
    - an event driven notification agent, for Wayland, built using rust
...
- https://github.com/wushilin/vswitch
    - Language: Rust
    - A Secure, High Performance, EPOLL based L2 Virtual Switch. It supports unlimited virtual switch via single port, supporting many clients on independent virtual networks, also support network bridging, Auto IP configuration,Auto route configuration and more

- https://github.com/mapfumo/bacnet-gateway
    - Language: Rust
    - Unified IIoT monitoring platform combining LoRaWAN, Modbus TCP, and BACnet/IP sensor data into Grafana dashboards. Features embedded Rust firmware for STM32 microcontrollers with W5500 Ethernet, raw socket protocol implementations (no external libs), Python bridges, InfluxDB 2, and Docker Compose infrastructure.
...
- https://github.com/fayard4real/venomized
    - Language: Rust
    - An educational project demonstrating the core concepts of multiplayer game networking over QUIC, visualized in Rust using the TUI app
...
- https://github.com/excoffierleonard/wg-tui
    - Language: Rust
...
- https://github.com/threefoldtech/zos_init_client
    - Language: Rust
...
- https://github.com/pronzzz/kernel-architect
    - Language: Rust
    - The Kernel Architect is a terminal-based cyberpunk simulation game built with Rust and Ratatui. Players explore, analyze, and hack into procedurally generated digital clusters using cellular automata. The game supports both local play and a unique SSH server mode for remote sessions.

- https://github.com/ByteMaster2003/null-talk
    - Language: Rust
    - 🚀 High-performance, E2EE chat application built in Rust. Features a Ratatui TUI client and a scalable server stress-tested to 100K+ concurrent TCP connections. Implements RSA & double encryption for maximum security.

- https://github.com/mhajder/tftp-rs
    - Language: Rust
    - A high-performance, single-binary TFTP server with a real-time TUI dashboard. Implements the TFTP protocol from scratch with full support for Read (RRQ), Write (WRQ), RFC 2347/2348 option negotiation, and an optional HTTP file server.

- https://github.com/gvariable/fssh
    - Language: Rust
    - An intuitive TUI application that speeds up SSH connections with password caching and server search capabilities.

- https://github.com/rhellstrom/resource-monitor
    - Language: Rust
    - Resource Monitor - A Rust-based Lightweight Server Monitoring Tool

- https://github.com/JiwanChung/ggoto
    - Language: Rust
    - A blazingly fast TUI for managing SSH connections with real-time server health monitoring
...
- https://github.com/TUI-Sushi/Monitor
    - Language: Rust
    - TUI to monitor remote server performance without installing serverside software.

- https://github.com/Neixen911/miMusic
    - Language: Rust
    - miMusic, a self-hosted audio player designed for lightweight systems. Performance based. Include a free song downloader.
...
- https://github.com/quasiL/tuixel
    - Language: Rust
    - TUIxel - A Terminal UI for Server Management
...
- https://github.com/TysonLabs/lazyide
    - Language: Rust
...
- https://github.com/KURANADO2/lazyssh
    - Language: Rust
...
- https://github.com/Yengas/rust-chat-server
    - Language: Rust
    - Room based Chat Server and TUI implementation in Rust
...
- https://github.com/xaerru/chatui
    - Language: Rust
    - ChatApp made using the standard library net module and tui-rs.

- https://github.com/QuakeWang/storify
    - Language: Rust
...
- https://github.com/uzairali19/orkesy
    - Language: Rust
    - Runtime-agnostic TUI for managing services, logs, commands, and metrics

- https://github.com/abhayymishraa/pingme-tui
    - Language: Rust
    - A lightweight command line interface tool for creating in-house web status servers. it makes end user to easily setup web status for their endpoints.
...
- https://github.com/flipperzero-rs/flipperzero-rs
    - Language: Rust
...
- https://github.com/libraries/gameboy
    - Language: Rust
...
- https://github.com/nikivdev/code
    - Language: Rust
...
- https://github.com/will-be-done/will-be-done
    - Language: TypeScript
    - Offline-first, self-hosted TickTick/Todoist alternative focused on weekly planning. Day columns, project boards, drag & drop, Vim keybindings, and an instant UI without loading spinners.
...
- https://github.com/pbbg/awesome-pbbg
    - Language: ?
...
- https://github.com/lanedirt/OGameX
    - Language: PHP
    - Open-source OGame redesign clone, powered by the latest PHP Laravel framework

- https://github.com/Shadowss/TravianZ
    - Language: PHP
    - Travian T3.6 with user-configurable features (enable/disable).
...
- https://github.com/feed-rs/feed-rs
    - Language: Rust
...
- https://github.com/Arcticons-Team/Arcticons-Linux
    - Language: Python
    - New repo https://codeberg.org/Arcticons/Arcticons-Linux

- https://github.com/MolassesLover/Nordzy-icon
    - Language: Shell
    - Nordzy is a free and open-source icon theme for Linux desktops, using the Nord color palette by Arctic Ice Studio, and based on the WhiteSur and Numix Icon themes.

- https://github.com/Arcticons-Team/Arcticons
    - Language: Java
    - A monotone line-based icon pack for android

- https://github.com/mdm/confidante
    - Language: Rust
    - A Rust XMPP server
...
- https://github.com/Velooroo/Flare
    - Language: Rust
    - A lightweight toolchain for deploying applications to edge devices, cyberdecks, and home labs. Written in Rust, it replaces Ansible/Docker with a single-binary daemon. Features instant TCP deployment, UDP auto-discovery, built-in reverse proxy (Gateway), and support for both GitHub and self-hosted Forge git servers. Zero dependencies on target.
...
- https://github.com/gianndev/ParvaOS
    - Language: Rust
    - ParvaOS is an Operating System created completely in Rust 🦀
...
- https://github.com/yonasBSD/zinit
    - Language: Rust
    - An init replacement that feels like runit. Written in Rust.

- https://github.com/Marketscrape/marketscrape-web
    - Language: Python
    - Marketscrape is a user-friendly web scraper for Facebook Marketplace that utilizes AI to help users assess the value of each listing. By providing real-time analysis and advanced machine learning algorithms, Marketscrape empowers users to make informed purchasing decisions and find the best deals on Facebook Marketplace.

- https://github.com/slint-ui/madewithslint
    - Language: HTML
...
- https://github.com/rinit-org/rinit
    - Language: Rust
    - Next-gen init and service-manager written in Rust
...
- https://github.com/HideakiToro/Todo-CLI
    - Language: Rust
    - A small todo list for the linux terminal

- https://github.com/ravindran-dev/todo-tui
    - Language: Rust
    - A terminal-based Todo application built using Rust and TUI, designed to be fast, safe, and keyboard-driven.

- https://github.com/daimh/todotree
    - Language: Rust
    - print todos with a tree of dependencies
...
- https://github.com/ignlg/pingkeeper
    - Language: Rust
    - Command line application that monitorizes the exit status of a check (command or ping or network response) and, in case of failure, runs a command. Optionally it can monitor that the provided command is permanently running, triggering a restart (kill & run) if checking fails.
...
- https://github.com/catacombing/gorm
    - Language: Rust
    - Moved to SourceHut
...
- https://github.com/Wachamuli/morpheus
    - Language: Shell
    - Desktop environment built using EWW library.
...
- https://github.com/sonic-liberation/spotube-plugin-spotify
    - Language: Kotlin
    - Unofficial Spotify metadata plugin for Spotube
...
- https://github.com/brandonio21/cargo-makepkg
    - Language: Rust
    - Build ArchLinux packages from cargo
...
- https://github.com/nexa-sys/nexa-os
    - Language: Rust
...
- https://github.com/olafkfreund/cosmic-ext-notifications-ng
    - Language: Rust
...
- https://github.com/vertiond/verthash-one-click-miner
    - Language: Go
...
- https://github.com/Bejmach/Pods
    - Language: Rust
    - notification daemon

- https://github.com/LucaCoduriV/Notiflut-Land
    - Language: Rust
...
- https://github.com/KushalMeghani1644/RustyTodos
    - Language: Rust
    - A GUI Todo List app built in Rust for managing your tasks.
...
- https://github.com/maocide/UndeadWallpaper
    - Language: Kotlin
    - Turn any video on your phone into a seamless live wallpaper. 100% Free & FOSS. No bullshit
...
- https://github.com/Saketh-Chandra/doom-ascii-wasm
    - Language: C
    - DOOM ASCII WASM port for Raycast
...
- https://github.com/MathisBurger/git-contrib-aggregator
    - Language: Rust
    - A self-hosted service for aggregating all my contributions to different git servers.
...
- https://github.com/michael-grunder/gitchat-relay-server
    - Language: Rust
    - Toy E2E encrypted chat app
...
- https://github.com/DevilxKiller/package-repository-server
    - Language: Rust
    - 📦 Host a multi-format package repository server for DEB, RPM, Arch, and Alpine packages with automatic indexing, GPG signing, and multi-architecture support.
...
- https://github.com/XertroV/discourse-rss-auto-archive-linked-content
    - Language: Rust
    - A Rust service that monitors a Discourse forum's RSS feed, detects links to ephemeral user-generated content (Reddit, TikTok, Twitter/X, YouTube, etc.), archives that content to S3, and provides a public web interface for browsing and searching archived material. The goal is to preserve referenced content for ongoing discussion.
...
- https://github.com/keys-i/tinyserve
    - Language: Rust
    - Superfast, ultra-lightweight Rust HTTP file server. Serves any file type with correct MIME for in-browser preview/streaming (HTML, images, PDF, MP3, MP4). Single binary, zero-config.
...
- https://github.com/Mjkli/ObscuraLink
    - Language: Rust
    - Create your own encryption new for securly browsing the web
...
- https://github.com/funnyboy-roks/wannabe-ssh
    - Language: Rust
    - Allow one to run pre-defined commands on a computer from a web browser
...
- https://github.com/clejacquet/rust-wgpu-raytracing
    - Language: Rust
...
- https://github.com/igorsantos07/webapp-wrappers
    - Language: Rust
    - Simple Tauri wrappers to run web applications on standalone desktop apps, independent from the main browser and with their own icons
...
- https://github.com/elde-n/tridactyl-native
    - Language: Rust
    - An unoffical native client for the tridactyl web-browser extension

- https://github.com/46ki75/web-image-converter
    - Language: Rust
...
- https://github.com/text-yoga/ask
    - Language: Rust
    - WIP browser-based LLM question/answering for the web

- https://github.com/PhoenixFlame101/wasm-webgl-viewer
    - Language: Rust
    - Toy viewer to run rust (graphics) programs in the browser using WASM
...
- https://github.com/joinemm/rust-wasm-webgl
    - Language: Rust
    - Using Rust compiled into WebAssembly to run 3D graphics in browser

- https://github.com/OmChillure/webbrowser
    - Language: Rust
    - A simple browser Made Using RUST , using TCP IP Listeners and Thread Pooling

- https://github.com/saku-koodari/web-pc
    - Language: Rust
    - PC inside a web browseer
...
- https://github.com/aki-akaguma/webapp-broinfo
    - Language: Rust
...
- https://github.com/kllarena07/qzgen
    - Language: Rust
    - Easy QRCode generator via the web browser
...
- https://github.com/JakubSokolowski/aoc-web
    - Language: Rust
    - Advent of Code solutions, run in browser with WASM
...
- https://github.com/Fabian2000/desktop-style-website
    - Language: Rust
    - Real browser based operating system

- https://github.com/Jason5Lee/rslide
    - Language: Rust
    - A web service that allows you to move through multiple html pages in the browser like a slide, even without focusing on the app console or the browser. Currently only supports Windows.
...
- https://github.com/notTamion/web-runnables
    - Language: Rust
    - Run local commands from your Browser
...
- https://github.com/tzervas/webpuppet-rs
    - Language: Rust
...
- https://github.com/npetrangelo/BFTML
    - Language: Rust
    - Blazingly Fast Text Markup Language. Standards designed for web apps. Browser implementation in Rust.
...
- https://github.com/0xwonj/websh
    - Language: Rust
    - A verifiable personal archive built on a browser-native virtual filesystem.
...
- https://github.com/voctal/epsilon
    - Language: Rust
    - Epsilon is an open-source search engine made in Rust.
...
- https://github.com/mineichen/llm-web-chat
    - Language: Rust
    - Showcase ollama usage within a browser

- https://github.com/fwcd/trails
    - Language: Rust
    - Experimental web browser and rendering engine written from scratch

- https://github.com/shaunbennett/lucis-web
    - Language: Rust
    - Raytracing in your web browser
...
- https://github.com/w-henderson/WebPL
    - Language: Rust
...
- https://github.com/OmniKee/OmniKee
    - Language: Rust
    - A KeePass-compatible password manager for Linux, Windows, Android, and your web browser
...
- https://github.com/newDINO/web-fs
    - Language: Rust
    - Wasm file System for browser based on File System API.
...
- https://github.com/plantacerium/GreenmeraldNotes
    - Language: Rust
    - Greenmerald Notes is: Rust CLI - Graphical Interface - To Explore Content Folder - Unfold Folder/s - Render Markdown FIles, Interactive Markdown FIles.
...
- https://github.com/regolith-labs/ore-cli-legacy
    - Language: Rust
...
- https://github.com/m0veax/mumbleping-rs
    - Language: Rust
    - Libary to send ping to mumble instance

- https://github.com/RandyMcMillan/mumble-rs
    - Language: Rust
    - mumble-rs

- https://github.com/SpaceManiac/mumble-link-rs
    - Language: Rust
...
- https://github.com/LimerBoy/BlazeRAT
    - Language: Python
    - :fire: Control your Linux home computer with telegram bot.
...
- https://github.com/chayotic/Open-Source-Music-Streaming-Apps
    - Language: ?
    - A curated list of open-source alternatives to Spotify and YouTube Music.

- https://github.com/fxdave/vonal-rust
    - Language: Rust
    - Modern customizable global menu with unlimiting plugin system written in Rust
...
- https://github.com/RockinChaos/AniSchedule
    - Language: JavaScript
    - A fully automated tool that fetches and organizes schedules and episode feeds for current airing anime, including dubs, subs, and hentai. The generated files are updated regularly and published directly to this repository.
...
- https://github.com/velvet-os/imagebuilder
    - Language: Shell
    - velvet os - simple script framework to build debian 13 trixie (in older versions also 12/bookworm, 11/bullseye and some ubuntu) bootable usb / sd card images for some arm and intel devices - lots of prebuilt images as well

- https://github.com/JuraSecurity/Worm-GPT
    - Language: Batchfile
...
- https://github.com/OshekharO/awesome-entertainment
    - Language: CSS
    - List of awesome apps and website for entertainment.
...
- https://github.com/anshumanv/awesome-anime-sources
    - Language: ?
    - A curated list of everything related to anime.

- https://github.com/notryanb/music-player
    - Language: Rust
...
- https://github.com/eligamii/goldberg-patcher
    - Language: Rust
    - A simple cross-platform tool to automatically path games with the Goldberg Emulator
...
- https://github.com/notrevenant/BetterSteamAutoCracker
    - Language: Rust
    - Imagined a nice looking Auto Cracker that is as little as ~8MB and is wicked fast? Say, "hi" to BSAC!
...
- https://github.com/avtzis/awesome-linux-ricing
    - Language: ?
    - 🎨 Curated list of awesome themes, tools and apps for customizing the Linux environment.
...
- https://github.com/SajjadHadi/Harmoniq
    - Language: Vue
    - Local music player with Tauri and Vue

- https://github.com/DownMaple/music-win
    - Language: Vue
    - Music software, produced using tauri + vue3 + ts + vite + pinia

- https://github.com/Laefye/FurPlayer
    - Language: Rust
    - YouTube Video/Music Player in Rust (Tauri)

- https://github.com/callum-jones19/coralia
    - Language: Rust
    - A cross-platform local music player, written in Rust and Typescript.

- https://github.com/lpradopostigo/grass-music-player
    - Language: Rust
    - desktop music player with gapless playback

- https://github.com/2gn/tatar
    - Language: Rust
    - A youtube music client made with tauri

- https://github.com/muzik-apps/muzik-offline
    - Language: Rust
    - A cross platform, local music player

- https://github.com/KrisShin/musicbox
    - Language: TypeScript
    - A simple music downloader with Tauri, Support multi-platform.

- https://github.com/xudong7/tauri-rmusic
    - Language: TypeScript
...
- https://github.com/Wookhq/Lution-old
    - Language: Python
    - literally a bloxstrap clone 4 linux

- https://github.com/Mahatur/RobloxSoberRamdisk
    - Language: Shell
    - Unecessary enough
...
- https://github.com/dfrnoch/nitro-generator
    - Language: Python
...
- https://github.com/equinoxhq/lucem
    - Language: Nim
    - [Currently doesn't work] An open-source bootstrapper for Sober, similar to Bloxstrap.

- https://github.com/equinoxhq/equinox
    - Language: Nim
    - A runtime for Roblox on Linux using containers.

- https://github.com/Nightro-Fx/Performance-FastFlags
    - Language: JavaScript
...
- https://github.com/chayleaf/konigsberg
    - Language: Rust
...
- https://github.com/imjord/imjord_tauri_games_launcher
    - Language: Rust
    - A remake of my electron app launching games but made in tauri
...
- https://github.com/HALLauncher/hal
    - Language: Rust
    - Paradox Launcher Alternative written in rust with tauri framework
...
- https://github.com/ResetPower/Epherome
    - Language: TypeScript
    - [Deprecated] This repository is obsolete. Please go to Epheromeers/Epherome instead.

- https://github.com/kunkunsh/kunkun
    - Language: TypeScript
    - An open source, cross-platform, extensible app launcher.

- https://github.com/mason-larobina/torrent-combine
    - Language: Rust
    - A tool to merge partially completed torrent data downloads.

- https://github.com/wotakumoe/meow-rs
    - Language: Rust
    - Even faster utility to batch-download .torrent files from Nyaa.

- https://github.com/naim94a/udpt
    - Language: Rust
...
- https://github.com/Heroic-Games-Launcher/gog-proxy
    - Language: Rust
    - Proxy arround GOG to extend API for Linux native games

- https://github.com/playtron-os/gog-warp
    - Language: Rust
    - Rust library for interfacing with GOG API
...
- https://github.com/AchetaGames/egs-api-rs
    - Language: Rust
    - Minimal rust crate to access Epic Games API

- https://github.com/PyKnight8/SGM
    - Language: Rust
    - Steam Game Manager (SGM) is a CLI based program that can launch steam games when you provide their name in a string that resembles the closest match to your desired game and it should launch. This program requires you to have a steam API key as well as know your steam ID in numeric style (not custom URLs)
...
- https://github.com/Sigma-dev/bevy_steam_p2p
    - Language: Rust
    - An opiniated networking framework to make developping low stakes online multiplayer games for free through the Steamworks API
...
- https://github.com/crabby-ai/les
    - Language: Rust
...
- https://github.com/PhilipK/steamgriddb_api
    - Language: Rust
    - A wrapper for https://www.steamgriddb.com/api written in Rust.
...
- https://github.com/YLohkuhl/personalBadges
    - Language: TypeScript
    - A Vencord plugin to create profile badges that are exclusively visible to you through locally stored data.
...
- https://github.com/Sirherobrine23/go-pproxit
    - Language: Go
    - Opensource playit.gg alternative - mirror
...
- https://github.com/Small-Ku/turbo-bucket
    - Language: PowerShell
...
- https://github.com/novasamatech/parity-signer
    - Language: Rust
    - Air-gapped crypto wallet.

- https://github.com/lolaimban18sliser/Silent-Crypto-Miner
    - Language: Rust
    - A free silent (undetected) native cryptocurrency miner capable of mining ETH, ETC, XMR, RTM and much more, with many features suited for mining silently.
...
- https://github.com/cliffordfajardo/awesome-web-browsers
    - Language: ?
...
- https://github.com/MidnightBSD/raphael
    - Language: Vala
    - Raphael Web Browser

- https://github.com/gaeulbyul/non-webkit
    - Language: ?
...
- https://github.com/DeityLamb/dfetch
    - Language: Rust
    - Simply minimalist fetch written in Rust.
...
- https://github.com/crabnebula-dev/taurify-examples
    - Language: TypeScript
    - Project examples for Taurify https://docs.crabnebula.dev/taurify
...
- https://github.com/Rabbit-Company/CryptoBal-Desktop
    - Language: Rust
    - Desktop application for monitoring your crypto assets.

- https://github.com/mdSilo/mdSilo-app
    - Language: TypeScript
    - Lightweight Knowledge Base and Feed Reader.

- https://github.com/VarunPotti/twidge
    - Language: TypeScript
...
- https://github.com/Charlie-117/ezdeb
    - Language: Go
    - A CLI application that helps users manage debian packages from 3rd party websites and GitHub repositories.

- https://github.com/abigaliz/krustyfy
    - Language: Rust
    - Notification daemon made in rust and qt

- https://github.com/Dr-42/end-rs
    - Language: Rust
...
- https://github.com/0u44/Termux-Hotspot
    - Language: Shell
    - A wireless access point orchestration framework that leverages Linux networking subsystems to create software-defined network infrastructure with captive portal authentication, NAT routing capabilities, and DHCP services directly from Android terminal environments. (termux)
...
- https://github.com/arxifythedev/free-domains
    - Language: ?
    - 🌐 Grab your own subdomain (for personal sites, open-source projects, and more) for free

- https://github.com/Juanperias/run-it
    - Language: Rust
    - A new gen package manager, written in rust

- https://github.com/loaden/gitauri
    - Language: Rust
    - Tauri gui for git written in rust.
...
- https://github.com/knightfallxz/Hyprland-Custom-Configuration
    - Language: Shell
    - Dotfiles for Hyprland , waybar , fish , tmux

- https://github.com/hen6003/iodine
    - Language: Rust
    - Init system written in rust

- https://github.com/RGafiyatullin/broom
    - Language: Rust
    - A minimal init-process

- https://github.com/gblach/definite-control
    - Language: Rust
    - Linux init + services supervisor

- https://github.com/sisungo/airup
    - Language: Rust
    - Modern, portable and fast implementation of service supervisor and the init daemon.
...
- https://github.com/jlpatter/oxidized_git
    - Language: Rust
...
- https://github.com/JustNeoNixy/zephyr-os
    - Language: Rust
    - Your Operating System running in your browser!
...
- https://github.com/iliketwertles/twinit
    - Language: Rust
...
- https://github.com/mesalock-linux/minit
    - Language: Rust
    - An init utility purely written in Rust.

- https://github.com/snoyberg/pid1-rust-poc
    - Language: Rust

- https://github.com/maxking/getup
    - Language: Rust
    - A simple init system for Linux system.

- https://github.com/tyler569/rsinit
    - Language: Rust
    - A Linux init system in Rust

- https://github.com/ente76/systemd.rs
    - Language: ?

- https://github.com/uhub/awesome-rust
    - Language: ?
    - A curated list of awesome Rust frameworks, libraries and software.

- https://github.com/troglodytto/zeno-legacy
    - Language: Rust
...
- https://github.com/HXM4Tech/GalaxyOS
    - Language: Rust
...
- https://github.com/d0u9/Linux-Device-Driver-Rust
    - Language: Rust
...
- https://github.com/crypto-chiefs/dnsbox
    - Language: Go
...
- https://github.com/GNUqb114514/vimiwm
    - Language: Rust
    - A vim-inspired WM written in rust

- https://github.com/TheNerdyHamster/tnh-wm
    - Language: Rust
    - Personal WM written in rust with Penrose
...
- https://github.com/hyprland-rs/hyprland-rs
    - Language: Rust
    - Hyprland-rs is The Best Wayland Compositor, rewritten in Rust
...
- https://github.com/MemerGamer/raklap
    - Language: Rust
    - Raklap is a wayland compatible tiling window manager written in Rust.

- https://github.com/FyraLabs-Graveyard/electrum
    - Language: Rust
    - A Wayland-only window manager and compositor for the Quicksilver project
...
- https://github.com/Boocord/discord-client
    - Language: ?
    - lightweight open-source discord client that you need.
...
- https://github.com/Ragnaroek/mithril
    - Language: Rust
...
- https://github.com/manujainz/notesy-android
    - Language: Kotlin
    - AI-Based Notes App designed to make the note-taking experience seamless and fluid.

- https://github.com/Dhravya/notty
    - Language: TypeScript
...
- https://github.com/Bertus-W/crates-io-android
    - Language: Kotlin

- https://github.com/phip1611/rust-kernel-x86_64-static-link-code-model-kernel
    - Language: Makefile
...
- https://github.com/starina-os/starina
    - Language: Rust
...
- https://github.com/mdaverde/kernel-modules-rust
    - Language: Rust
...
- https://github.com/tristonarmstrong/Zlum
    - Language: Rust
    - Rage is a rust based git ui kind of like Gogs / cgit.

- https://github.com/defenxor/dsiem-rs
    - Language: Rust
    - Dsiem in Rust 🦀

- https://github.com/AdaStaysSilly/native-ui-rs
    - Language: Rust
    - A rust library to provide UI abstractions to be implemented by different toolkits
...
- https://github.com/SamKnightGit/Oxide
    - Language: Rust
...
- https://github.com/Terrazzo-Web/Terminal
    - Language: ?
    - Web terminal built with Terrazzo

- https://github.com/medwards/gitt
    - Language: Rust
...
- https://github.com/roscoevanderboom/rusted-bolt
    - Language: TypeScript
